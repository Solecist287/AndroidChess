...
public abstract class GameActivity extends AppCompatActivity {
    ...
    protected final static List<BiFunction<Integer,Character,Piece>> promotionConstructors = Arrays.asList(Queen::new, Rook::new, Bishop::new, Knight::new);//constructors for pawn promotions
    protected final static String[] promotionLevels = {"(Q) Queen", "(R) Rook", "(B) Bishop", "(N) Knight"};//used for pawn promotion display
    ...
    protected abstract void concludeTurn();
    //popup stuff
